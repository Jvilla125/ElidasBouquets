...
const CheckOutFormComponent = ({cartSubtotal}) => {
    return (
        <>
            <form className="p-6 bg-blue-200 rounded-lg w-fit">
                ...
                <div className="grid md:grid-cols-2 md:gap-6 ">
                    <div className="relative z-0 w-full  group py-2 px-4 mb-4 bg-white rounded-lg ">
                ...
                <div className="py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 dark:bg-gray-800 dark:border-gray-700">
                    <label for="comment" className="sr-only">Special instructions or comments</label>
                ...
                <button disabled={cartSubtotal === 0} type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Check Out!
                </button>
            </form>
        </>
