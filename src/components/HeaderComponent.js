                                ...
                                {userInfo.isAdmin ? (
                                    ...
                                    <div className="dropdown inline-block relative ">
                                        <button className="py-2 px-4 rounded inline-flex items-center">
                                            <span className="text-xl lg:text-base lg:inline-block hover:text-blue-500 ">{userInfo.name} {userInfo.lastName}</span>
                                        ...
                                        <ul className="dropdown-menu absolute grid grid-cols-2 gap-4 hidden text-gray-700 pt-1 z-20">
                                            <li className="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap"><Link to="/user"> My Profile</Link></li>
                                            <li className="rounded-t bg-gray-200 hover:bg-gray-400 py-2 px-4 block whitespace-no-wrap"><Link to="/user/order-history"> My Orders</Link></li>
